...
const cardArray = [
...

  {
    ...
    avg: { key: 'avrSoc', label: '평균', mr: 7.5625 },
  },
  {
    label: 'SOH(%)',
    min: { key: 'minSoh', label: '최소값' },
    max: { key: 'maxSoh', label: '최대값' },
    avg: { key: 'avrSoh', label: '평균', mr: 7.5625 },
  },
]
